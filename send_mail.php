...
try {
    ...
    //Recipients
    $mail->setFrom('akshayy1802@gmail.com', 'Mailer');         //Set the sender of the message (your email address)
    $mail->addAddress('akshhing1802@gmail.com', 'Joe User');     //Add a recipient (your bae's email address)
